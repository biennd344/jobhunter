...
import vn.bin.jobhunter.domain.response.file.ResUploadFileDTO;
import vn.bin.jobhunter.service.FileService;
import vn.bin.jobhunter.util.annotation.ApiMessage;
import vn.bin.jobhunter.util.error.StorageException;
...
public class FileController {
    ...
    public ResponseEntity<Resource> download(@RequestParam(name = "fileName", required = false) String fileName,
        ...
        if (fileName == null || folder == null) {
            throw new StorageException("Missing required params (fileName or folder is empty)");
        }
